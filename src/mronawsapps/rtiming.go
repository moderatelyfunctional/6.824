...
func Map(filename string, contents string) []mronaws.KeyValue {

	kva := []mronaws.KeyValue{}
	kva = append(kva, mronaws.KeyValue{"a", "1"})
	kva = append(kva, mronaws.KeyValue{"b", "1"})
	kva = append(kva, mronaws.KeyValue{"c", "1"})
	kva = append(kva, mronaws.KeyValue{"d", "1"})
	kva = append(kva, mronaws.KeyValue{"e", "1"})
	kva = append(kva, mronaws.KeyValue{"f", "1"})
	kva = append(kva, mronaws.KeyValue{"g", "1"})
	kva = append(kva, mronaws.KeyValue{"h", "1"})
	kva = append(kva, mronaws.KeyValue{"i", "1"})
	kva = append(kva, mronaws.KeyValue{"j", "1"})
	return kva
}
