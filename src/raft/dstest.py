...
# python dstest.py TestInitialElection2A, TestReElection2A, TestManyElections2A -p 10 -n 1000 -o output -r
...
# python dstest.py TestInitialElection2A, TestReElection2A, TestManyElections2A TestBasicAgree2B, TestRPCBytes2B, TestFollowerFailure2B, 
# 				 TestLeaderFailure2B, TestFailAgree2B, TestFailNoAgree2B, TestConcurrentStarts2B, TestRejoin2B, TestBackup2B, TestCount2B
