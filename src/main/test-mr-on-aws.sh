...
(cd ../../mronawsapps && go build $RACE -buildmode=plugin mtiming.go) || exit 1
(cd ../../mronawsapps && go build $RACE -buildmode=plugin rtiming.go) || exit 1
(cd ../../mronawsapps && go build $RACE -buildmode=plugin jobcount.go) || exit 1
(cd ../../mronawsapps && go build $RACE -buildmode=plugin early_exit.go) || exit 1
(cd ../../mronawsapps && go build $RACE -buildmode=plugin crash.go) || exit 1
(cd ../../mronawsapps && go build $RACE -buildmode=plugin nocrash.go) || exit 1
...
$TIMEOUT ../mronawsworker ../../mronawsapps/mtiming.so &
$TIMEOUT ../mronawsworker ../../mronawsapps/mtiming.so
...
$TIMEOUT ../mronawsworker ../../mronawsapps/rtiming.so &
$TIMEOUT ../mronawsworker ../../mronawsapps/rtiming.so
...
$TIMEOUT ../mronawsworker ../../mronawsapps/jobcount.so &
$TIMEOUT ../mronawsworker ../../mronawsapps/jobcount.so
$TIMEOUT ../mronawsworker ../../mronawsapps/jobcount.so &
$TIMEOUT ../mronawsworker ../../mronawsapps/jobcount.so
...
($TIMEOUT ../mronawscoordinator ../pg*txt ; touch $DF) &

# give the coordinator time to create the sockets.
sleep 1

# start multiple workers.
($TIMEOUT ../mronawsworker ../../mronawsapps/early_exit.so ; touch $DF) &
($TIMEOUT ../mronawsworker ../../mronawsapps/early_exit.so ; touch $DF) &
($TIMEOUT ../mronawsworker ../../mronawsapps/early_exit.so ; touch $DF) &
...
# generate the correct output
../mronawssequential ../../mronawsapps/nocrash.so ../pg*txt || exit 1
